...
namespace SharpGL
{
    public partial class OpenGL
    {
        ...
        {
            return (bool)InvokeExtensionFunction<wglDXSetResourceShareHandleNV>(dxObject, shareHandle);
        }

        public IntPtr DXOpenDeviceNV(IntPtr dxDevice)
        {
            return (IntPtr)InvokeExtensionFunction<wglDXOpenDeviceNV>(dxDevice);
        }

        public bool DXCloseDeviceNV(IntPtr hDevice)
        {
            return (bool)InvokeExtensionFunction<wglDXCloseDeviceNV>(hDevice);
        }

        public IntPtr DXRegisterObjectNV(IntPtr hDevice, IntPtr dxObject, uint name, uint type, uint access)
        {
            return (IntPtr)InvokeExtensionFunction<wglDXRegisterObjectNV>(hDevice, dxObject, name, type, access);
        }

        public bool DXUnregisterObjectNV(IntPtr hDevice, IntPtr hObject)
        {
            return (bool)InvokeExtensionFunction<wglDXUnregisterObjectNV>(hDevice, hObject);
        }

        public bool DXObjectAccessNV(IntPtr hObject, uint access)
        {
            return (bool)InvokeExtensionFunction<wglDXObjectAccessNV>(hObject, access);
        }
        ...
        public bool DXLockObjectsNV(IntPtr hDevice, IntPtr[] hObjects)
        {
            unsafe
            {
                ...
                return (bool)InvokeExtensionFunction<wglDXLockObjectsNV>(hDevice, hObjects.Length, new IntPtr(objects));
            }
        }
        ...
        public bool DXUnlockObjectsNV(IntPtr hDevice, IntPtr[] hObjects)
        {
            unsafe
            {
                ...
                return (bool)InvokeExtensionFunction<wglDXUnlockObjectsNV>(hDevice, hObjects.Length, new IntPtr(objects));
            }
        }
