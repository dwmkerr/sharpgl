...
{
    public class NormalTranslucentMaterialProgram : ShaderProgramJOG
    {
        #region fields
        List<NTMBufferGroup> _bufferGroups = new List<NTMBufferGroup>();
        ...
        #region properties
        public List<NTMBufferGroup> BufferGroups
        {
        ...
        private static Dictionary<ShaderTypes, string> ShaderTypeAndCode
        {
            get
            {
                ...
                stc.Add(ShaderTypes.GL_VERTEX_SHADER, SharpGL.SceneGraph.JOG.ManifestResourceLoader.LoadTextFile("ShaderResources.NormalTranslucentMaterial.vert", assembly));
                stc.Add(ShaderTypes.GL_FRAGMENT_SHADER, SharpGL.SceneGraph.JOG.ManifestResourceLoader.LoadTextFile("ShaderResources.NormalTranslucentMaterial.frag", assembly));
        ...
        #region constructors
        public NormalTranslucentMaterialProgram(OpenGL gl)
            :base(gl, ShaderTypeAndCode, AttributeNames, UniformNames)
        {
        }
        #endregion constructors

        public void AddBufferGroup(NTMBufferGroup group)
        {
