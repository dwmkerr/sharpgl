...
namespace SharpGLMaterialSample
{
    public class NMBufferGroup
    {
        ...
        #region constructors
        public NMBufferGroup(OpenGL gl)
        {
            CreateBufferIds(gl);
        }
        ...
        public void PrepareVAO(OpenGL gl, NormalMaterialProgram program)
        {
        ...
        public void BindVBOs(OpenGL gl, NormalMaterialProgram program)
        {
