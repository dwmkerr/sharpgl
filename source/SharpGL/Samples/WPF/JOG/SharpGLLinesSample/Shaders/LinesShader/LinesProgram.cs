...
{
    public class LinesProgram : ShaderProgramJOG
    {
        #region fields
        List<LinesBufferGroup> _bufferGroups = new List<LinesBufferGroup>();
        ...
        #region properties
        public List<LinesBufferGroup> BufferGroups
        {
        ...
        private static Dictionary<ShaderTypes, string> ShaderTypeAndCode
        {
            get
            {
                ...
                stc.Add(ShaderTypes.GL_VERTEX_SHADER, SharpGL.SceneGraph.JOG.ManifestResourceLoader.LoadTextFile("ShaderResources.SingleColor.vert", assembly));
                stc.Add(ShaderTypes.GL_FRAGMENT_SHADER, SharpGL.SceneGraph.JOG.ManifestResourceLoader.LoadTextFile("ShaderResources.SingleColor.frag", assembly));
